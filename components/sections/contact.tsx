            ...
            <div className="container mx-auto px-6 md:px-12 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center">
                    ...
                    <div className="flex flex-col items-center gap-3 text-center">
                        <div className="p-4 rounded-full bg-zinc-900 border border-zinc-800 text-accent">
                            <MapPin className="w-6 h-6" />
                        </div>
                        <div>
                            <p className="text-gray-300 font-medium">Quito, Ecuador</p>
                            <p className="text-gray-500 text-xs text-nowrap">Remote (UTC-8 to -4)</p>
                        </div>
                    </div>

                    {/* Email */}
                    <a href="mailto:and_sg@outlook.com" className="group flex flex-col items-center gap-3 text-center">
                        <div className="p-4 rounded-full bg-zinc-900 border border-zinc-800 text-accent group-hover:border-accent group-hover:bg-accent/10 transition-all duration-300">
                            <Mail className="w-6 h-6" />
                        </div>
                        <span className="text-gray-300 group-hover:text-white transition-colors text-sm">and_sg@outlook.com</span>
                    </a>
