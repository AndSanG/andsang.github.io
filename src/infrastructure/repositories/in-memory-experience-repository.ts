    ...
    async getExperiences(): Promise<Experience[]> {
        return [
            ...
            },
            {
                ...
                company: "iuvity (Todo1 Services Inc.)",
                description: "Stepped up as de facto coordinator for a distributed team of external providers. Delivered banking UI features for Banistmo (Panama) using VIPER architecture through iuvity's SaaS platform. Refactored legacy Objective-C codebases to Swift, migrated layouts to iPhone X (Safe Area, AutoLayout), and coordinated App Store releases via TestFlight, Fastlane, and Jenkins.",
                imagePath: '/iuvity.jpeg',
                color: "text-blue-500"
            },
            {
