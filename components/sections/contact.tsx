            ...
            <div className="container mx-auto px-6 md:px-12 text-center">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 justify-items-center">
                    ...
                    <div className="flex flex-col items-center gap-3 text-center">
                        <div className="p-4 rounded-full bg-white/60 dark:bg-zinc-900/50 backdrop-blur-md backdrop-saturate-150 border border-white/50 dark:border-white/10 ring-1 ring-inset ring-white/30 dark:ring-white/5 text-accent">
                    ...
                    <a href={`mailto:${contact.email}`} className="group flex flex-col items-center gap-3 text-center">
                        <div className="p-4 rounded-full bg-white/60 dark:bg-zinc-900/50 backdrop-blur-md backdrop-saturate-150 border border-white/50 dark:border-white/10 ring-1 ring-inset ring-white/30 dark:ring-white/5 text-accent group-hover:border-accent/50 group-hover:bg-accent/10 transition-all duration-300">
